...
CREATE UNIQUE INDEX user_oauth_accounts_provider_user_unique
ON user_oauth_accounts (provider, user_id);

CREATE UNIQUE INDEX user_oauth_accounts_provider_user_id_unique
...
CREATE UNIQUE INDEX oauth_login_states_hash_unique ON oauth_login_states (state_hash);
...
CREATE UNIQUE INDEX oauth_login_tickets_hash_unique ON oauth_login_tickets (ticket_hash);
CREATE INDEX oauth_login_tickets_user_id_idx ON oauth_login_tickets (user_id);
